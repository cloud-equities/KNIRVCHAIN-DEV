...
func (db *LevelDB) GetBlockchain(address string) (interface{}, error) {
	return nil, fmt.Errorf("not implemented") // remove and prevent undefined type errors for now
}

func (db *LevelDB) PutIntoDb(blockchain interface{}, address string) error {
	return fmt.Errorf("not implemented") // remove and prevent undefined type errors for now
